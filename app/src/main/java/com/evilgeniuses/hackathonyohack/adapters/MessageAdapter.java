...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageAdapter.ViewHolder holder, int position) {
        ...
        if (position == mMessage.size()-1){
            if (chat.isIsseen()){
                holder.txt_seen.setText("Просмотрен");
            } else {
                holder.txt_seen.setText("Доставлен");
            }
        } else {
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            show_message = itemView.findViewById(R.id.textViewMessage);
            profile_image = itemView.findViewById(R.id.textViewProfileImage);
            textViewTime = itemView.findViewById(R.id.textViewTime);
            txt_seen = itemView.findViewById(R.id.textViewSeen);
        }
    }
